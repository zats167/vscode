...
Page({
    ...
    onLoad: function(t) {
        ...
        util.getUrl(a, function(e) {}), e.util.request({
    ...
    formSubmit: function(t) {
        ...
        var n = wx.getStorageSync("openid"), o = t.detail.value.czje, i = this.data.czhd, s = wx.getStorageSync("users").id;
        if (console.log(i), 0 == i.length) var c = o; else if (Number(o) >= Number(this.data.czhd[i.length - 1].full)) {
            var l = this.jsmj(o, i);
            console.log(l), c = Number(o) + Number(i[l].reduction);
        } else c = o;
        console.log(n, o, s, c), e.util.request({
